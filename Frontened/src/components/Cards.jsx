...
function Cards({ item, onClick }) {
  return (
    <div onClick={onClick} tabIndex="0" role="button">
      <div className="card bg-base-100 w-80 md:w-96 shadow-xl mt-8  hover:scale-105 duration-200 dark:text-black h-[450px]">
        <figure>
          <img className='w-full h-64 object-cover' src={item.image} alt="Anime" />
        </figure>
